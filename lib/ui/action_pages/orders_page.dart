...
class _OrdersPageState extends State<OrdersPage> {
  ...
  _sendPdf(DataSnapshot snapshot) async {
      ...
      pw.Page(
        build: (context) {
          ...
          return pw.Column(
            ...
            children: [
              pw.Text('Сатылым №$id', style: pw.TextStyle(fontSize: 20, font: font)),
    ...
    final file = File('${directory.path}/satylym_$id.pdf');
    await file.writeAsBytes(await pdf.save());

    // Отправляем PDF файл через WhatsApp
    await ShareExtend.share(file.path, "file", subject: "satylym_$id.pdf");
  }
