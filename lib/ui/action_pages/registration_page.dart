...
class _RegPageState extends State<RegPage> {
  ...
  void _placeOrder() {
    ...
    FirebaseDatabase.instance.reference().child('users').child(uid).child("registration").orderByKey().limitToLast(1).once().then((event) {
      ...
      FirebaseDatabase.instance.reference().child('users').child(uid).child("registration").child(orderId).set({
        'id' : orderId,
            ...
            GestureDetector(
                ...
                child:Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                        children:[
                          Text('Кіріс жасау', style: TextStyle(color: color4, fontSize: 16,fontWeight: FontWeight.w600)),
                        ]
                    ),
                  ),
                )),
